...
export class EthemeralLifeForce extends ethereum.SmartContract {
  static bind(address: Address): EthemeralLifeForce {
    return new EthemeralLifeForce("EthemeralLifeForce", address);
  }
