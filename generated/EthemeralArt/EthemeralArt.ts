...
export class EthemeralArt extends ethereum.SmartContract {
  static bind(address: Address): EthemeralArt {
    return new EthemeralArt("EthemeralArt", address);
  }
...
export class MintAmountsCall extends ethereum.Call {
  get inputs(): MintAmountsCall__Inputs {
    return new MintAmountsCall__Inputs(this);
  }

  get outputs(): MintAmountsCall__Outputs {
    return new MintAmountsCall__Outputs(this);
  }
}

export class MintAmountsCall__Inputs {
  _call: MintAmountsCall;

  constructor(call: MintAmountsCall) {
    this._call = call;
  }
...
export class MintAmountsCall__Outputs {
  _call: MintAmountsCall;
